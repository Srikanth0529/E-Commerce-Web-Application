package com.srikanth.www.controller;
...
import com.srikanth.www.service.ProductService;
...
public class ProductController 
{
	...
	public ResponseEntity<String> deleteProduct(@PathVariable int id)
	{
		...
		{
			return new ResponseEntity<>("Failed to Delete The Product",HttpStatus.NOT_FOUND);
		}
	}
